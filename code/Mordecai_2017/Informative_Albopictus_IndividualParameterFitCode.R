...
## measure, (EFD = TFD*(1/a), where a is the biting rate). 
...
#### The albopictus data on are on eggs per gonotrophic cycle, whereas the priors were fit
#### from data on eggs per day, so they will have different heights. I rescaled the heights to match before
#### fitting the informative priors.


hypers = gamma.fits.TFD*0.1
...
# This is fit as the lifespan, lf, in lifespan-comp-script-informative.R 
...
# The prior data were fit with a Quadratic function
...
save(a.samps, MDR.samps, TFD.samps, e2a.samps, b.samps, c.samps, PDR.samps,
	 file = "Informative_Albopictus_ParameterFits_2016-03-30.Rsave")
