...
## survives. Which will be analyzed as lf in lifespan-comp-script-informative.R and the
...
par(mfrow=c(1,1))
mycol<-1 
plot(data$T, data$trait, xlim = c(5, 50), 
     pch=(mycol+20),
     xlab="Temperature (C)",
     ylab=data$trait.name[1],
     ylim=c(0.10,0.35),
...
save(a.samps, b.samps, c.samps, MDR.samps, EFD.samps, 
     e2a.samps, PDR.samps, 
     file = "Informative_Aegypti_DENV_ParameterFits_2016-03-30.Rsave")
save(PDR.samps, b.samps, c.samps, file = "Informative_Aegypti_b_c_DENV_PDR_samps_2016-03-30.Rsave")
